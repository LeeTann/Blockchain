...
class Blockchain(object):
    ...
    def proof_of_work(self):
        ...
        # create a loop and pass block string and proof into valid_proof
    ...
    def valid_proof(block_string, proof):
        ...
        """
        # TODO
        # hash the block strings and proof together
        # return true if the hash starts with 6 zeros, False otherwise
...
def mine():
    ...
    if blockchain.valid_proof(block_string, new_proof):
        ...
        response = {
            'message': 'proof was invalid or it was already submitted, try again!'
        }
        return jsonify(response), 200
...
def new_block():
    ...
    if received_block['index'] == old_block['index'] + 1:
        ...
        # start using the new longest chain
        print('chain has changed: ', blockchain.chain)
